!function(e){if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.reading=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
"use strict";
...
var build = _dereq_('./bear.js');
var utils = _dereq_('./utils.js');
var toggle = _dereq_('./toggle.js');
...
var listeners = function(elements, bear) {
    addListener(window, "load", function(keys, themes) {
        ...
        while ( pointer ) {
            if ( utils.isHeaderTag(bear[pointer].tag) ) {
                ...
                addListener(elements[pointer], "click", toggle.handler(elements, bear));
            }
            pointer--;
...
},{"./bear.js":1,"./toggle.js":4,"./utils.js":5}],3:[function(_dereq_,module,exports){
...
(function() {
    ...
    var utils = _dereq_('./utils.js');
    var toggle = _dereq_('./toggle.js');
    var listeners = _dereq_('./listeners.js');

//    var elements = window.document.body.children;
    console.log(document);
    // make a map of the document
//    var bear = build();
...
},{"./bear.js":1,"./listeners.js":2,"./toggle.js":4,"./utils.js":5}],4:[function(_dereq_,module,exports){
"use strict";
...
utils.makeActive = function(elements, bear, me) {
    ...
    //console.log(me);
    // uses global var "url"
    var meep = this.elemNumber(me, bear.numberOfElements);
