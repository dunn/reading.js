...
var listeners = {
    ...
    onpress: function(elements, bear) {
        ...
        addListener(window, "keypress", function(key) {
            ...
            var nextIndex = function(bear, direction, header) {
                var down = direction === "down";
                var head = header === "header";
                var i = utils.activeIndex(bear);
                i = (down ? i + 1 : i - 1);
                //console.log(elements[i]);
                while ((utils.oneOf(bear[i].tag, scrollSkip) > -1) ||
                       (utils.oneOf("hidden", bear[i].classes) > -1) ||
                       (header ? utils.isHeaderTag(bear[i].tag) : false)) {
                    (down ? i++ : i--);
                }
        ...
        // };
            ...
            case keys.next :
                ...
                utils.makeActive(elements, bear, elements[nextIndex(bear, "down", "")]);
                break;
                // if they press 'k' go up:
            case keys.prev :
                utils.makeActive(elements, bear, elements[nextIndex(bear, "up", "")]);
                break;
            ...
            case keys.last :
                ...
                break;
                // if they press "i", go to the previous header
            case keys.prevUp :
                utils.makeActive(elements, bear, elements[nextIndex(bear, "up", "header")]);
                break;
                // if they press "o" go to the next header
            case keys.nextUp :
                utils.makeActive(elements, bear, elements[nextIndex(bear, "down", "header")]);
                break;
