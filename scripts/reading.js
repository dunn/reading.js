...
var helpBoxText = "<p><a href=\"#" + startId + "\" title=\"Skip to content\">Skip to content</a></p><aside><h3>Keyboard shortcuts</h3><ul><li><span class=\"key\">" + String.fromCharCode(keyNext) + "</span> Next section</li><li><span class=\"key\">" + String.fromCharCode(keyPrev) + "</span> Previous section</li><li><span class=\"key\">return/enter</span> Toggle active section</li><li><span class=\"key\">" + String.fromCharCode(keyNextUp) + "</span> Next section (one level up)</li><li><span class=\"key\">" + String.fromCharCode(keyPrevUp) + "</span> Previous section (one level up)</li><li><span class=\"key\">" + String.fromCharCode(keyFirst) + "</span> First section</li><li><span class=\"key\">" + String.fromCharCode(keyLast) + "</span> Last section</li><li><span class=\"key\">" + String.fromCharCode(keyAll) + "</span> Toggle everything in this section</li><li><span class=\"key\">" + String.fromCharCode(keyExpand) + "</span> Expand all sections (do this before you search)</li><li><span class=\"key\">" + String.fromCharCode(keyTheme) + "</span> Switch theme</li></ul></aside>";
